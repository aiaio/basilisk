# -*- encoding: utf-8 -*-
 ...
 Gem::Specification.new do |s|
  ...
  s.files = ["HISTORY", "LICENSE", "README.rdoc", "bin/basil", "bin/basil.rb", "lib/basilisk.rb", "lib/basilisk/core.rb", "lib/basilisk/parser.rb", "lib/basilisk/processor.rb", "lib/basilisk/template.rb", "lib/basilisk/processors/error_processor.rb", "lib/basilisk/processors/seo_processor.rb", "lib/basilisk/processors/terms_processor.rb", "lib/basilisk/processors/sitemap_processor.rb", "test/basilisk_test.rb", "test/test_helper.rb"]
  s.test_files = ["test/basilisk_test.rb", "test/test_helper.rb"]
  s.require_paths = ["lib"]
  s.executables = ["basil", "basil.rb"]
  s.has_rdoc = true
